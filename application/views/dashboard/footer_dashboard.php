...
<!-- Custom JS login -->
<script src="../public/assets/dist/js/dashboard.js"></script>
<!-- DataTables  & Plugins -->
...
<?php switch ($this->session->site_lang) {
  case 'spanish':
    $src="../public/assets/dist/js/dashboard.js";
    break;

  case 'english':
    $src="../public/assets/dist/js/dashboard_en.js";
    break;
  
  default:
    $src="../public/assets/dist/js/dashboard_pt.js";
    break;
} 
?>
